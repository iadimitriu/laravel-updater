...
class Updater
{
     ...
     * @return array
     */
    protected function pendingUpdates($files, $ran)
    {
        return Collection::make($files)
                ->reject(function ($file) use ($ran) {
                    return in_array($this->getUpdateName($file), $ran);
                })->values()->all();
    }
     ...
     * @return void
     */
    public function runPending(array $updates, array $options = [])
    {
     ...
     * @return void
     */
    protected function runUpdate($update, $method)
    {
...
//            if (method_exists($migration, $method)) { // This should be uncommented.
...
//        return new $file;
     ...
     * @return array
     */
    public function getUpdaterFiles($paths)
    {
     ...
     * @return string
     */
    public function getUpdateName($path)
    {
...
//     * @param  \Illuminate\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
    public function fireUpdateEvent($event)
    {
        if ($this->events) {
